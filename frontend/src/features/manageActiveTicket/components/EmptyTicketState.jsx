export default function EmptyTicketState() {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] max-w-lg mx-auto text-center gap-4 animate-fade-in px-4">
      <div className="w-24 h-24 bg-teal-50 rounded-full flex items-center justify-center shadow-inner border border-teal-100 mb-2">
        <span className="material-symbols-outlined text-[48px] text-teal-300" style={{ fontVariationSettings: "'FILL' 1" }}>
          check_circle
        </span>
      </div>
      <h2 className="text-xl font-black text-[#003036] tracking-tight">¡Todo en Orden!</h2>
