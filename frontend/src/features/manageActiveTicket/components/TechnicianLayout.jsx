    ...
    <div className="bg-[#f8f9ff] font-public-sans text-[#0b1c30] min-h-screen selection:bg-[var(--md-primary-container)] selection:text-white">
      ...
      <header className="fixed top-0 left-0 w-full flex justify-between items-center px-4 h-14 bg-white/80 backdrop-blur-xl border-b border-slate-200/50 shadow-sm z-50">
        <div className="flex items-center gap-2">
          <span className="material-symbols-outlined text-[var(--md-primary-container)] text-[20px]" style={{ fontVariationSettings: "'FILL' 1" }}>settings_input_antenna</span>
          <span className="text-base font-bold text-[#004851] tracking-tight">Cali-Tech WiFi</span>
        </div>
      ...
      <div className="flex pt-14 min-h-screen">
        ...
        <aside className="hidden md:flex flex-col w-52 fixed h-[calc(100vh-56px)] bg-white border-r border-slate-200/50 p-4 z-40">
          <nav className="space-y-1.5 flex-grow">
            <div className="mb-6">
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-3 px-2">Work Space</p>
              <Link 
                to="/technician" 
              ...
              >
                <span className="material-symbols-outlined text-[18px]" style={{ fontVariationSettings: !isHistory ? "'FILL' 1" : "" }}>assignment</span>
              ...
              >
                <span className="material-symbols-outlined text-[18px]" style={{ fontVariationSettings: isHistory ? "'FILL' 1" : "" }}>history</span>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 w-full flex justify-around items-center px-4 h-16 bg-white/90 backdrop-blur-md border-t border-slate-200/50 shadow-[0_-4px_12px_rgba(0,72,81,0.08)] z-50 rounded-t-xl">
        ...
        >
          <span className="material-symbols-outlined text-[20px]" style={{ fontVariationSettings: !isHistory ? "'FILL' 1" : "" }}>assignment</span>
        ...
        >
          <span className="material-symbols-outlined text-[20px]" style={{ fontVariationSettings: isHistory ? "'FILL' 1" : "" }}>history</span>
